...
forecast_start_date = '2024-08-30 15:00:00'
...
for date in forecast_dates:
    ...
    combined_forecast = (0.3 * rolling_mean_value) + (0.5 * prophet_pred)  # Weighted to favor Prophet's predictions more
