...
filtered_df = df[(df['PRODNAME'] == 3300000002) & (df['TANKNUM'] == 3)].copy()
...
historical_df = filtered_df[filtered_df['ds'] < '2024-08-30']

# Prepare actual data from a specific date
actual_df = filtered_df[(filtered_df['ds'] >= '2024-08-30') & (filtered_df['ds'] <= '2024-09-01')]
...
forecast_start_date = '2024-08-30 13:00:00'
...
for date in forecast_dates:
    ...
    combined_forecast = (0.4 * rolling_mean_value) + (0.4 * prophet_pred)  # Weighted to favor Prophet's predictions more
...
forecast_days_df = merged_df[(merged_df.index >= '2024-08-30') & (merged_df.index < '2024-08-31')]
