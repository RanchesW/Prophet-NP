...
filtered_df = df[(df['PRODNAME'] == 3300000002) & (df['TANKNUM'] == 1)].copy()
...
historical_df = filtered_df[filtered_df['ds'] < '2024-09-06']

# Prepare actual data from a specific date
actual_df = filtered_df[(filtered_df['ds'] >= '2024-09-06') & (filtered_df['ds'] <= '2024-09-07')]
...
forecast_start_date = '2024-09-06 18:00:00'
forecast_end_date = '2024-09-07 23:59:59'
...
for date in forecast_dates:
    ...
    combined_forecast = (0.3 * rolling_mean_value) + (0.7 * prophet_pred)  # Weighted to favor Prophet's predictions more
...
forecast_days_df = merged_df[(merged_df.index >= '2024-09-06') & (merged_df.index < '2024-09-07')]
